...
define("SMTP_UNAME", "canhlong1430@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "0981249458"); //Password for SMTP authentication
